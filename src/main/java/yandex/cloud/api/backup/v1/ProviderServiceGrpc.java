...
@javax.annotation.Generated(
    ...
    comments = "Source: yandex/cloud/backup/v1/provider_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ProviderServiceGrpc {

  private ProviderServiceGrpc() {}

  public static final String SERVICE_NAME = "yandex.cloud.backup.v1.ProviderService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Activate",
      requestType = yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest.class,
      responseType = yandex.cloud.api.operation.OperationOuterClass.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest, yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod;
      ...
      synchronized (ProviderServiceGrpc.class) {
        if ((getActivateMethod = ProviderServiceGrpc.getActivateMethod) == null) {
          ProviderServiceGrpc.getActivateMethod = getActivateMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest, yandex.cloud.api.operation.OperationOuterClass.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Activate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest,
      yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse> getListActivatedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListActivated",
      requestType = yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest.class,
      responseType = yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest,
      yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse> getListActivatedMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest, yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse> getListActivatedMethod;
      ...
      synchronized (ProviderServiceGrpc.class) {
        if ((getListActivatedMethod = ProviderServiceGrpc.getListActivatedMethod) == null) {
          ProviderServiceGrpc.getListActivatedMethod = getListActivatedMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest, yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListActivated"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse.getDefaultInstance()))
  ...
  public static abstract class ProviderServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void activate(yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest request,
     ...
     * </pre>
     */
    public void listActivated(yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest,
                yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse>(
  ...
  public static final class ProviderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProviderServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.operation.OperationOuterClass.Operation activate(yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest request) {
     ...
     * </pre>
     */
    public yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse listActivated(yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ProviderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ProviderServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.operation.OperationOuterClass.Operation> activate(
        yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse> listActivated(
        yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ACTIVATE:
          serviceImpl.activate((yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ActivateProviderRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.operation.OperationOuterClass.Operation>) responseObserver);
          break;
        case METHODID_LIST_ACTIVATED:
          serviceImpl.listActivated((yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.backup.v1.ProviderServiceOuterClass.ListActivatedProvidersResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProviderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return yandex.cloud.api.backup.v1.ProviderServiceOuterClass.getDescriptor();
    }

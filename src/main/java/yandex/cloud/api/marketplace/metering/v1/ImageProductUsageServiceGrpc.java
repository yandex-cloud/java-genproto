...
@javax.annotation.Generated(
    ...
    comments = "Source: yandex/cloud/marketplace/metering/v1/image_product_usage_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ImageProductUsageServiceGrpc {

  private ImageProductUsageServiceGrpc() {}

  public static final String SERVICE_NAME = "yandex.cloud.marketplace.metering.v1.ImageProductUsageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest,
      yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse> getWriteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Write",
      requestType = yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest.class,
      responseType = yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest,
      yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse> getWriteMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest, yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse> getWriteMethod;
      ...
      synchronized (ImageProductUsageServiceGrpc.class) {
        if ((getWriteMethod = ImageProductUsageServiceGrpc.getWriteMethod) == null) {
          ImageProductUsageServiceGrpc.getWriteMethod = getWriteMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest, yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Write"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse.getDefaultInstance()))
  ...
  public static abstract class ImageProductUsageServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void write(yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest,
                yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse>(
                  this, METHODID_WRITE)))
          .build();
    }
  }
  ...
  public static final class ImageProductUsageServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ImageProductUsageServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse write(yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest request) {
  ...
  public static final class ImageProductUsageServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ImageProductUsageServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse> write(
        yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WRITE:
          serviceImpl.write((yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.WriteImageProductUsageResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ImageProductUsageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return yandex.cloud.api.marketplace.metering.v1.ImageProductUsageServiceOuterClass.getDescriptor();
    }

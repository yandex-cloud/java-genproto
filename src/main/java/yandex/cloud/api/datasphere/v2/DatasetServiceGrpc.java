...
@javax.annotation.Generated(
    ...
    comments = "Source: yandex/cloud/datasphere/v2/dataset_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class DatasetServiceGrpc {

  private DatasetServiceGrpc() {}

  public static final String SERVICE_NAME = "yandex.cloud.datasphere.v2.DatasetService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Activate",
      requestType = yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest.class,
      responseType = yandex.cloud.api.operation.OperationOuterClass.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest, yandex.cloud.api.operation.OperationOuterClass.Operation> getActivateMethod;
    if ((getActivateMethod = DatasetServiceGrpc.getActivateMethod) == null) {
      synchronized (DatasetServiceGrpc.class) {
        if ((getActivateMethod = DatasetServiceGrpc.getActivateMethod) == null) {
          DatasetServiceGrpc.getActivateMethod = getActivateMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest, yandex.cloud.api.operation.OperationOuterClass.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Activate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new DatasetServiceMethodDescriptorSupplier("Activate"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getDeactivateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Deactivate",
      requestType = yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest.class,
      responseType = yandex.cloud.api.operation.OperationOuterClass.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getDeactivateMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest, yandex.cloud.api.operation.OperationOuterClass.Operation> getDeactivateMethod;
    if ((getDeactivateMethod = DatasetServiceGrpc.getDeactivateMethod) == null) {
      synchronized (DatasetServiceGrpc.class) {
        if ((getDeactivateMethod = DatasetServiceGrpc.getDeactivateMethod) == null) {
          DatasetServiceGrpc.getDeactivateMethod = getDeactivateMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest, yandex.cloud.api.operation.OperationOuterClass.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Deactivate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new DatasetServiceMethodDescriptorSupplier("Deactivate"))
              .build();
        }
      }
    }
  ...
  public static abstract class DatasetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void activate(yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest request,
     ...
     * </pre>
     */
    public void deactivate(yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.operation.OperationOuterClass.Operation> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest,
                yandex.cloud.api.operation.OperationOuterClass.Operation>(
  ...
  public static final class DatasetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DatasetServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.operation.OperationOuterClass.Operation activate(yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest request) {
     ...
     * </pre>
     */
    public yandex.cloud.api.operation.OperationOuterClass.Operation deactivate(yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class DatasetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DatasetServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.operation.OperationOuterClass.Operation> activate(
        yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.operation.OperationOuterClass.Operation> deactivate(
        yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ACTIVATE:
          serviceImpl.activate((yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.ActivateDatasetRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.operation.OperationOuterClass.Operation>) responseObserver);
          break;
        case METHODID_DEACTIVATE:
          serviceImpl.deactivate((yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.DeactivateDatasetRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.operation.OperationOuterClass.Operation>) responseObserver);
          break;
        default:
  ...
  private static abstract class DatasetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return yandex.cloud.api.datasphere.v2.DatasetServiceOuterClass.getDescriptor();
    }

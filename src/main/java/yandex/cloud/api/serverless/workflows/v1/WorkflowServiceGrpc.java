...
public final class WorkflowServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessBindingsRequest,
    ...
    if ((getListAccessBindingsMethod = WorkflowServiceGrpc.getListAccessBindingsMethod) == null) {
      synchronized (WorkflowServiceGrpc.class) {
        if ((getListAccessBindingsMethod = WorkflowServiceGrpc.getListAccessBindingsMethod) == null) {
          WorkflowServiceGrpc.getListAccessBindingsMethod = getListAccessBindingsMethod =
              ...
              .setSchemaDescriptor(new WorkflowServiceMethodDescriptorSupplier("ListAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.SetAccessBindingsRequest,
    ...
    if ((getSetAccessBindingsMethod = WorkflowServiceGrpc.getSetAccessBindingsMethod) == null) {
      synchronized (WorkflowServiceGrpc.class) {
        if ((getSetAccessBindingsMethod = WorkflowServiceGrpc.getSetAccessBindingsMethod) == null) {
          WorkflowServiceGrpc.getSetAccessBindingsMethod = getSetAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new WorkflowServiceMethodDescriptorSupplier("SetAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessBindingsRequest,
    ...
    if ((getUpdateAccessBindingsMethod = WorkflowServiceGrpc.getUpdateAccessBindingsMethod) == null) {
      synchronized (WorkflowServiceGrpc.class) {
        if ((getUpdateAccessBindingsMethod = WorkflowServiceGrpc.getUpdateAccessBindingsMethod) == null) {
          WorkflowServiceGrpc.getUpdateAccessBindingsMethod = getUpdateAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new WorkflowServiceMethodDescriptorSupplier("UpdateAccessBindings"))
              .build();
        }
      }
    }

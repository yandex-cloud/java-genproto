...
public final class ChannelServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessBindingsRequest,
    ...
    if ((getListAccessBindingsMethod = ChannelServiceGrpc.getListAccessBindingsMethod) == null) {
      synchronized (ChannelServiceGrpc.class) {
        if ((getListAccessBindingsMethod = ChannelServiceGrpc.getListAccessBindingsMethod) == null) {
          ChannelServiceGrpc.getListAccessBindingsMethod = getListAccessBindingsMethod =
              ...
              .setSchemaDescriptor(new ChannelServiceMethodDescriptorSupplier("ListAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.SetAccessBindingsRequest,
    ...
    if ((getSetAccessBindingsMethod = ChannelServiceGrpc.getSetAccessBindingsMethod) == null) {
      synchronized (ChannelServiceGrpc.class) {
        if ((getSetAccessBindingsMethod = ChannelServiceGrpc.getSetAccessBindingsMethod) == null) {
          ChannelServiceGrpc.getSetAccessBindingsMethod = getSetAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ChannelServiceMethodDescriptorSupplier("SetAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessBindingsRequest,
    ...
    if ((getUpdateAccessBindingsMethod = ChannelServiceGrpc.getUpdateAccessBindingsMethod) == null) {
      synchronized (ChannelServiceGrpc.class) {
        if ((getUpdateAccessBindingsMethod = ChannelServiceGrpc.getUpdateAccessBindingsMethod) == null) {
          ChannelServiceGrpc.getUpdateAccessBindingsMethod = getUpdateAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ChannelServiceMethodDescriptorSupplier("UpdateAccessBindings"))
              .build();
        }
      }
    }

...
public final class ClusterServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.StreamClusterLogsRequest,
      yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord> getStreamLogsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord.class,
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.StreamClusterLogsRequest,
      yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord> getStreamLogsMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.StreamClusterLogsRequest, yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord> getStreamLogsMethod;
      ...
      synchronized (ClusterServiceGrpc.class) {
        if ((getStreamLogsMethod = ClusterServiceGrpc.getStreamLogsMethod) == null) {
          ClusterServiceGrpc.getStreamLogsMethod = getStreamLogsMethod = 
              io.grpc.MethodDescriptor.<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.StreamClusterLogsRequest, yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord.getDefaultInstance()))
  ...
  public static abstract class ClusterServiceImplBase implements io.grpc.BindableService {
    ...
    public void streamLogs(yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.StreamClusterLogsRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord> responseObserver) {
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                ...
                yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord>(
  ...
  public static final class ClusterServiceBlockingStub extends io.grpc.stub.AbstractStub<ClusterServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<yandex.cloud.api.mdb.redis.v1.ClusterServiceOuterClass.LogRecord> streamLogs(
  ...
  private static final int METHODID_REBALANCE = 22;

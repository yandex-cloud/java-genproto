...
@javax.annotation.Generated(
    ...
    comments = "Source: yandex/cloud/mdb/mysql/v1/backup_service.proto")
public final class BackupServiceGrpc {

  private BackupServiceGrpc() {}

  public static final String SERVICE_NAME = "yandex.cloud.mdb.mysql.v1.BackupService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest,
      yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Get",
      requestType = yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest.class,
      responseType = yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest,
      yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup> getGetMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest, yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup> getGetMethod;
      ...
      synchronized (BackupServiceGrpc.class) {
        if ((getGetMethod = BackupServiceGrpc.getGetMethod) == null) {
          BackupServiceGrpc.getGetMethod = getGetMethod = 
              io.grpc.MethodDescriptor.<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest, yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "yandex.cloud.mdb.mysql.v1.BackupService", "Get"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest,
      yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "List",
      requestType = yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest.class,
      responseType = yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest,
      yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse> getListMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest, yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse> getListMethod;
    if ((getListMethod = BackupServiceGrpc.getListMethod) == null) {
      synchronized (BackupServiceGrpc.class) {
        if ((getListMethod = BackupServiceGrpc.getListMethod) == null) {
          BackupServiceGrpc.getListMethod = getListMethod = 
              io.grpc.MethodDescriptor.<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest, yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "yandex.cloud.mdb.mysql.v1.BackupService", "List"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse.getDefaultInstance()))
  ...
  public static abstract class BackupServiceImplBase implements io.grpc.BindableService {
    ...
    public void get(yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest,
                yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup>(
                  this, METHODID_GET)))
          .addMethod(
            getListMethod(),
            asyncUnaryCall(
  ...
  public static final class BackupServiceFutureStub extends io.grpc.stub.AbstractStub<BackupServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup> get(
        yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsResponse> list(
        yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.ListBackupsRequest request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET:
          serviceImpl.get((yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.GetBackupRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.mdb.mysql.v1.BackupOuterClass.Backup>) responseObserver);
          break;
        case METHODID_LIST:
  ...
  private static abstract class BackupServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return yandex.cloud.api.mdb.mysql.v1.BackupServiceOuterClass.getDescriptor();
    }

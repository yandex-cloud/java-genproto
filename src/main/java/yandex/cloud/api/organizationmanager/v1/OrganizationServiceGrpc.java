...
public final class OrganizationServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessPolicyBindingsRequest,
    ...
    if ((getListAccessPolicyBindingsMethod = OrganizationServiceGrpc.getListAccessPolicyBindingsMethod) == null) {
      synchronized (OrganizationServiceGrpc.class) {
        if ((getListAccessPolicyBindingsMethod = OrganizationServiceGrpc.getListAccessPolicyBindingsMethod) == null) {
          OrganizationServiceGrpc.getListAccessPolicyBindingsMethod = getListAccessPolicyBindingsMethod =
              ...
              .setSchemaDescriptor(new OrganizationServiceMethodDescriptorSupplier("ListAccessPolicyBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.BindAccessPolicyRequest,
    ...
    if ((getBindAccessPolicyMethod = OrganizationServiceGrpc.getBindAccessPolicyMethod) == null) {
      synchronized (OrganizationServiceGrpc.class) {
        if ((getBindAccessPolicyMethod = OrganizationServiceGrpc.getBindAccessPolicyMethod) == null) {
          OrganizationServiceGrpc.getBindAccessPolicyMethod = getBindAccessPolicyMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new OrganizationServiceMethodDescriptorSupplier("BindAccessPolicy"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UnbindAccessPolicyRequest,
    ...
    if ((getUnbindAccessPolicyMethod = OrganizationServiceGrpc.getUnbindAccessPolicyMethod) == null) {
      synchronized (OrganizationServiceGrpc.class) {
        if ((getUnbindAccessPolicyMethod = OrganizationServiceGrpc.getUnbindAccessPolicyMethod) == null) {
          OrganizationServiceGrpc.getUnbindAccessPolicyMethod = getUnbindAccessPolicyMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new OrganizationServiceMethodDescriptorSupplier("UnbindAccessPolicy"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessPolicyBindingParametersRequest,
    ...
    if ((getUpdateAccessPolicyBindingParametersMethod = OrganizationServiceGrpc.getUpdateAccessPolicyBindingParametersMethod) == null) {
      synchronized (OrganizationServiceGrpc.class) {
        if ((getUpdateAccessPolicyBindingParametersMethod = OrganizationServiceGrpc.getUpdateAccessPolicyBindingParametersMethod) == null) {
          OrganizationServiceGrpc.getUpdateAccessPolicyBindingParametersMethod = getUpdateAccessPolicyBindingParametersMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new OrganizationServiceMethodDescriptorSupplier("UpdateAccessPolicyBindingParameters"))
              .build();
        }
      }
    }
  ...
  private static final int METHODID_LIST_ACCESS_POLICY_BINDINGS = 7;
  private static final int METHODID_BIND_ACCESS_POLICY = 8;
  private static final int METHODID_UNBIND_ACCESS_POLICY = 9;
  private static final int METHODID_UPDATE_ACCESS_POLICY_BINDING_PARAMETERS = 10;

...
public final class TextGenerationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse> getCompletionMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse.class,
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse> getCompletionMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse> getCompletionMethod;
      ...
      synchronized (TextGenerationServiceGrpc.class) {
        if ((getCompletionMethod = TextGenerationServiceGrpc.getCompletionMethod) == null) {
          TextGenerationServiceGrpc.getCompletionMethod = getCompletionMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse.getDefaultInstance()))
  ...
  public static abstract class TextGenerationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void completion(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                ...
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse>(
  ...
  public static final class TextGenerationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TextGenerationServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse> completion(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COMPLETION:
          serviceImpl.completion((yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionResponse>) responseObserver);
          break;
        default:

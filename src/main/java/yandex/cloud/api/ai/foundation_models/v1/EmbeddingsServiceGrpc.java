...
public final class EmbeddingsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse> getTextEmbeddingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TextEmbedding",
      requestType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest.class,
      responseType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse> getTextEmbeddingMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse> getTextEmbeddingMethod;
      ...
      synchronized (EmbeddingsServiceGrpc.class) {
        if ((getTextEmbeddingMethod = EmbeddingsServiceGrpc.getTextEmbeddingMethod) == null) {
          EmbeddingsServiceGrpc.getTextEmbeddingMethod = getTextEmbeddingMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TextEmbedding"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse.getDefaultInstance()))
  ...
  public static abstract class EmbeddingsServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void textEmbedding(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest,
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse>(
  ...
  public static final class EmbeddingsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EmbeddingsServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse textEmbedding(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest request) {
  ...
  public static final class EmbeddingsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EmbeddingsServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse> textEmbedding(
        yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEXT_EMBEDDING:
          serviceImpl.textEmbedding((yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TextEmbeddingResponse>) responseObserver);
          break;
        default:

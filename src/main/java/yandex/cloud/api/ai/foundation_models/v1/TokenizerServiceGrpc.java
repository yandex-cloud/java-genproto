...
@javax.annotation.Generated(
    ...
    comments = "Source: yandex/cloud/ai/foundation_models/v1/foundation_models_service.proto")
...
public final class TokenizerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Tokenize",
      requestType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest.class,
      responseType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeMethod;
      ...
      synchronized (TokenizerServiceGrpc.class) {
        if ((getTokenizeMethod = TokenizerServiceGrpc.getTokenizeMethod) == null) {
          TokenizerServiceGrpc.getTokenizeMethod = getTokenizeMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Tokenize"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeCompletionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TokenizeCompletion",
      requestType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest.class,
      responseType = yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
      yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeCompletionMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> getTokenizeCompletionMethod;
      ...
      synchronized (TokenizerServiceGrpc.class) {
        if ((getTokenizeCompletionMethod = TokenizerServiceGrpc.getTokenizeCompletionMethod) == null) {
          TokenizerServiceGrpc.getTokenizeCompletionMethod = getTokenizeCompletionMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TokenizeCompletion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse.getDefaultInstance()))
  ...
  public static abstract class TokenizerServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void tokenize(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> responseObserver) {
     ...
     * </pre>
     */
    public void tokenizeCompletion(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest request,
        io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest,
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>(
                  this, METHODID_TOKENIZE)))
          .addMethod(
            getTokenizeCompletionMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
                yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>(
  ...
  public static final class TokenizerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TokenizerServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse tokenize(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest request) {
     ...
     * </pre>
     */
    public yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse tokenizeCompletion(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TokenizerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TokenizerServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> tokenize(
        yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse> tokenizeCompletion(
        yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TOKENIZE:
          serviceImpl.tokenize((yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>) responseObserver);
          break;
        case METHODID_TOKENIZE_COMPLETION:
          serviceImpl.tokenizeCompletion((yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest) request,
              (io.grpc.stub.StreamObserver<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.TokenizeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TokenizerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.getDescriptor();
    }

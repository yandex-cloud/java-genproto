...
public final class TextGenerationAsyncServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getCompletionMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.operation.OperationOuterClass.Operation> getCompletionMethod;
      ...
      synchronized (TextGenerationAsyncServiceGrpc.class) {
        if ((getCompletionMethod = TextGenerationAsyncServiceGrpc.getCompletionMethod) == null) {
          TextGenerationAsyncServiceGrpc.getCompletionMethod = getCompletionMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest, yandex.cloud.api.operation.OperationOuterClass.Operation>newBuilder()
  ...
  public static final class TextGenerationAsyncServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TextGenerationAsyncServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.operation.OperationOuterClass.Operation completion(yandex.cloud.api.ai.foundation_models.v1.FoundationModelsService.CompletionRequest request) {

...
public final class TextGenerationAsyncServiceGrpc {
  ...
  public static final String SERVICE_NAME = "yandex.cloud.ai.llm.v1alpha.TextGenerationAsyncService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.InstructRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getInstructMethod;
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.InstructRequest,
      yandex.cloud.api.operation.OperationOuterClass.Operation> getInstructMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.InstructRequest, yandex.cloud.api.operation.OperationOuterClass.Operation> getInstructMethod;
    if ((getInstructMethod = TextGenerationAsyncServiceGrpc.getInstructMethod) == null) {
      synchronized (TextGenerationAsyncServiceGrpc.class) {
        if ((getInstructMethod = TextGenerationAsyncServiceGrpc.getInstructMethod) == null) {
          TextGenerationAsyncServiceGrpc.getInstructMethod = getInstructMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.llm.v1alpha.LlmService.InstructRequest, yandex.cloud.api.operation.OperationOuterClass.Operation>newBuilder()
              ...
              .setSchemaDescriptor(new TextGenerationAsyncServiceMethodDescriptorSupplier("Instruct"))
              .build();
        }
      }
    }
  ...
  public static final class TextGenerationAsyncServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TextGenerationAsyncServiceBlockingStub> {
     ...
     * </pre>
     */
    public yandex.cloud.api.operation.OperationOuterClass.Operation instruct(yandex.cloud.api.ai.llm.v1alpha.LlmService.InstructRequest request) {
  ...
  public static final class TextGenerationAsyncServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TextGenerationAsyncServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<yandex.cloud.api.operation.OperationOuterClass.Operation> instruct(

...
public final class TokenizerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeRequest,
      yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeResponse> getTokenizeMethod;
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeRequest,
      yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeResponse> getTokenizeMethod() {
    io.grpc.MethodDescriptor<yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeRequest, yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeResponse> getTokenizeMethod;
      ...
      synchronized (TokenizerServiceGrpc.class) {
        if ((getTokenizeMethod = TokenizerServiceGrpc.getTokenizeMethod) == null) {
          TokenizerServiceGrpc.getTokenizeMethod = getTokenizeMethod =
              io.grpc.MethodDescriptor.<yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeRequest, yandex.cloud.api.ai.llm.v1alpha.LlmService.TokenizeResponse>newBuilder()

...
public final class DiskPlacementGroupServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessBindingsRequest,
    ...
    if ((getListAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getListAccessBindingsMethod) == null) {
      synchronized (DiskPlacementGroupServiceGrpc.class) {
        if ((getListAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getListAccessBindingsMethod) == null) {
          DiskPlacementGroupServiceGrpc.getListAccessBindingsMethod = getListAccessBindingsMethod =
              ...
              .setSchemaDescriptor(new DiskPlacementGroupServiceMethodDescriptorSupplier("ListAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.SetAccessBindingsRequest,
    ...
    if ((getSetAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getSetAccessBindingsMethod) == null) {
      synchronized (DiskPlacementGroupServiceGrpc.class) {
        if ((getSetAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getSetAccessBindingsMethod) == null) {
          DiskPlacementGroupServiceGrpc.getSetAccessBindingsMethod = getSetAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new DiskPlacementGroupServiceMethodDescriptorSupplier("SetAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessBindingsRequest,
    ...
    if ((getUpdateAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getUpdateAccessBindingsMethod) == null) {
      synchronized (DiskPlacementGroupServiceGrpc.class) {
        if ((getUpdateAccessBindingsMethod = DiskPlacementGroupServiceGrpc.getUpdateAccessBindingsMethod) == null) {
          DiskPlacementGroupServiceGrpc.getUpdateAccessBindingsMethod = getUpdateAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new DiskPlacementGroupServiceMethodDescriptorSupplier("UpdateAccessBindings"))
              .build();
        }
      }
    }

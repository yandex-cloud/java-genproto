...
public final class SnapshotScheduleServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessBindingsRequest,
    ...
    if ((getListAccessBindingsMethod = SnapshotScheduleServiceGrpc.getListAccessBindingsMethod) == null) {
      synchronized (SnapshotScheduleServiceGrpc.class) {
        if ((getListAccessBindingsMethod = SnapshotScheduleServiceGrpc.getListAccessBindingsMethod) == null) {
          SnapshotScheduleServiceGrpc.getListAccessBindingsMethod = getListAccessBindingsMethod =
              ...
              .setSchemaDescriptor(new SnapshotScheduleServiceMethodDescriptorSupplier("ListAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.SetAccessBindingsRequest,
    ...
    if ((getSetAccessBindingsMethod = SnapshotScheduleServiceGrpc.getSetAccessBindingsMethod) == null) {
      synchronized (SnapshotScheduleServiceGrpc.class) {
        if ((getSetAccessBindingsMethod = SnapshotScheduleServiceGrpc.getSetAccessBindingsMethod) == null) {
          SnapshotScheduleServiceGrpc.getSetAccessBindingsMethod = getSetAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new SnapshotScheduleServiceMethodDescriptorSupplier("SetAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessBindingsRequest,
    ...
    if ((getUpdateAccessBindingsMethod = SnapshotScheduleServiceGrpc.getUpdateAccessBindingsMethod) == null) {
      synchronized (SnapshotScheduleServiceGrpc.class) {
        if ((getUpdateAccessBindingsMethod = SnapshotScheduleServiceGrpc.getUpdateAccessBindingsMethod) == null) {
          SnapshotScheduleServiceGrpc.getUpdateAccessBindingsMethod = getUpdateAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new SnapshotScheduleServiceMethodDescriptorSupplier("UpdateAccessBindings"))
              .build();
        }
      }
    }

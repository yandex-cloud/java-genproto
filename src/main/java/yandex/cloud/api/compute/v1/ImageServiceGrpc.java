...
public final class ImageServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.ListAccessBindingsRequest,
    ...
    if ((getListAccessBindingsMethod = ImageServiceGrpc.getListAccessBindingsMethod) == null) {
      synchronized (ImageServiceGrpc.class) {
        if ((getListAccessBindingsMethod = ImageServiceGrpc.getListAccessBindingsMethod) == null) {
          ImageServiceGrpc.getListAccessBindingsMethod = getListAccessBindingsMethod =
              ...
              .setSchemaDescriptor(new ImageServiceMethodDescriptorSupplier("ListAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.SetAccessBindingsRequest,
    ...
    if ((getSetAccessBindingsMethod = ImageServiceGrpc.getSetAccessBindingsMethod) == null) {
      synchronized (ImageServiceGrpc.class) {
        if ((getSetAccessBindingsMethod = ImageServiceGrpc.getSetAccessBindingsMethod) == null) {
          ImageServiceGrpc.getSetAccessBindingsMethod = getSetAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ImageServiceMethodDescriptorSupplier("SetAccessBindings"))
              .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<yandex.cloud.api.access.Access.UpdateAccessBindingsRequest,
    ...
    if ((getUpdateAccessBindingsMethod = ImageServiceGrpc.getUpdateAccessBindingsMethod) == null) {
      synchronized (ImageServiceGrpc.class) {
        if ((getUpdateAccessBindingsMethod = ImageServiceGrpc.getUpdateAccessBindingsMethod) == null) {
          ImageServiceGrpc.getUpdateAccessBindingsMethod = getUpdateAccessBindingsMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  yandex.cloud.api.operation.OperationOuterClass.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ImageServiceMethodDescriptorSupplier("UpdateAccessBindings"))
              .build();
        }
      }
    }
